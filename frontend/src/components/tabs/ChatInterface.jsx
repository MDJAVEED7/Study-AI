...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col h-[70vh] bg-white-900 backdrop-blur-3xl border rounded-md items-center justify-center shadow-lg shadow-secondary">
      <div className="flex-1 w-full p-6 overflow-y-auto bg-linear-to-br rounded-lg from-white-900 via-white-800 to-white-700">
        {history.length === 0 ? (
            ...
            <div className="flex items-center gap-3 my-4">
              ...
              <div className="flex items-center gap-2 p-3 rounded-2xl rounded-bl-md border">
                <div className="flex gap-1">
                  <span
                    className="w-2 h-2 rounded-full animate-bounce bg-white/70"
                    style={{ animationDelay: '0ms' }}
                  />
                  <span
                    className="w-2 h-2 rounded-full animate-bounce bg-white/80"
                    style={{ animationDelay: '150ms' }}
                  />
                  <span
                    className="w-2 h-2 rounded-full animate-bounce bg-white/90"
