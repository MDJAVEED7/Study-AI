  ...
  return (
    <div style={{ perspective: '1000px' }} className="relative w-full h-72">
      ...
      >
        {/* Front of card */}
        <div
          className="absolute inset-0 w-full h-full border-2 rounded-2xl shadow-md shadow-accent bg-linear-to-br to-white/40 from-accent/40 backdrop-blur-sm p-8 flex flex-col justify-between"
        ...
        {/* Back of card */}
        <div
          className="absolute inset-0 w-full h-full border-2 rounded-2xl bg-linear-to-br to-white/20 from-accent/20 backdrop-blur-sm p-8 flex flex-col justify-between"
          style={{
        ...
        >
          {/* Star Button */}
          <div className="flex items-start justify-between">
            <div className="rounded px-4 py-1 uppercase bg-white/40">{flashcard?.difficulty}</div>
            <button
              type="button"
              onClick={(e) => {
                e.stopPropagation();
