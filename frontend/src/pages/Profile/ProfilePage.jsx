          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <p className="w-full h-9 pl-9 pr-3 pt-1.5 border border-foreground/80 text-base rounded-lg bg-white/70 bg-gray900/70">
                  {username}
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <p className="w-full h-9 pl-9 pr-3 pt-1 border border-foreground/80 text-base rounded-lg bg-white/70 bg-gray900/70">
                  {email}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-9 border rounded-lg text-base pl-9 transition-colors duration-200 focus:outline-none focus:border-accent bg-white-900"
                />
              </div>
            </div>
